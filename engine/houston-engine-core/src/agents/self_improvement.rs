...
//!
//! Relocated from `app/houston-tauri/src/self_improvement.rs`. Transport-
//! neutral — the desktop adapter and any future REST surface inject the
//! same string into the assembled prompt.
